...
function CTABanner({ onNav }) {
  ...
  const waBtn = { background: '#25d366', color: '#fff', fontFamily: "'Inter',system-ui", fontWeight: 800, fontSize: 15, padding: '14px 26px', borderRadius: 12, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 10, alignSelf: 'flex-start', boxShadow: '0 14px 28px rgba(34,197,94,.35)', position: 'relative', zIndex: 1 };
