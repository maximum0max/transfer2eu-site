...
function ContactsPage({ onNav }) {
  ...
  // Booking band — same 2-step form used on the home/route pages.
  ...
  const bookH2 = { fontFamily: "'Onest',sans-serif", fontSize: 'clamp(26px, 3vw, 34px)', fontWeight: 800, color: 'var(--t2-ink)', margin: '8px 0 6px', letterSpacing: '-.02em', lineHeight: 1.1 };
  const bookLede = { fontSize: 15, color: 'var(--t2-ink-3)', margin: 0 };
  ...
  return (
    <>
      ...
      <div style={bookWrap}>
        <div style={bookInner}>
          <div style={bookHead}>
            <div style={bookEyebrow}>Бронирование</div>
            <h2 style={bookH2}>Забронируйте трансфер онлайн</h2>
            <p style={bookLede}>Выберите маршрут, заполните данные — заявка уйдёт в WhatsApp и на нашу почту.</p>
          </div>
          <BookingForm />
        </div>
      </div>
